...
ds1 = CsvFileSource('../../../data/prefix_log2_2011_q4_rand_skrm.csv') # 45000 events
ds2 = CsvFileSource('../../../data/postfix_log2_2011_q4_rand_skrm.csv') # 45000 events
...
player.forward()
# print heatmaps
#RasterUtil.write_geotiff_heatmap(heatmap_analyzer, normalize=True, path_prefix='popmap-pre-skrm')

################
# create cache #
################

print 'Creating (fat) heatmap based cache'
cache_heatmap = TileCacheBuilder.from_heatmap_k_coverage( heatmap_analyzer, k=0.9999 )
cache_heatmap.fatten(1)
RasterUtil.write_geotiff_heatmap(cache_heatmap, normalize=True, path_prefix='fat-cache-heat-pre-skrm')

print 'Creating KMS based cache'
cache_kms = TileCacheBuilder.from_seeding_plan( SeedingPlan.by_name('kms') )
#RasterUtil.write_geotiff_heatmap(cache_kms, normalize=True, path_prefix='cache-kms-skrm')
...
#RasterUtil.write_geotiff_heatmap(heatmap_analyzer, normalize=True, path_prefix='popmap-post-skrm')
...
print 'Stats (fat heatmap based cache):\n'
...
print 'Fat heatmap based, compared to seeding plan based:\n'
