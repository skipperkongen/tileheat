...
trad = CsvFileSource('../../../data/nov1_sampl_skrm.csv') # 
vald = CsvFileSource('../../../data/nov2_sampl_skrm.csv') # 
...
print 'actual'
Y_HEAT = [ opt.get_cell(c.resolution, c.row, c.col).value for c in heat.sorted_cells() ]
accumulate(Y_HEAT)
